...
const GoldCreateForm = ({ currentProperty }) => {
                    ...
                    <Card>
                        <Box sx={{ p: 3 }}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12} md={6}>
                                    <RHFTextField name="purity" label="Purity" fullWidth />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <RHFTextField name="weight" label="Weight" fullWidth />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <RHFTextField name="acquisitiondate" label="Acquisition Date" fullWidth />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <RHFTextField name="owner" label="Owner" fullWidth />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <RHFTextField name="storagelocatn" label="Storage Location" fullWidth />
                                </Grid>
                            </Grid>
                        </Box>
