...
function Tiles_Sanitary({currentProperty}) {
                ...
                <Box sx={{ p: 3 }}>
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="productname" label="ProductName" fullWidth />
                        </Grid>
                        <Grid item xs={12} md={6}>
                        ...
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="size" label="Size" fullWidth />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="color" label="Color" fullWidth />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="price" label="Price" fullWidth />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="stockqty" label="Stock Qty" fullWidth />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="supplier" label="Supplier" fullWidth />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <RHFTextField name="acquisitiondate" label="Acquisition Date" fullWidth />
                        </Grid>
